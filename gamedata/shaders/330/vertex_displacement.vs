...
void main()
{
    ...
    float displacement = texture(perlinNoiseMap, animatedTexCoord).r * 1.5; // Amplified displacement
    ...
    height = (displacement / 1.5); // send height to fragment shader for coloring
